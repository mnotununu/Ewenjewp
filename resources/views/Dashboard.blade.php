...
<script>
  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar" role="banner">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <h1 class="mb-0 site-logo"><a href="livestream/staysolid.html" class="text-white mb-0">STAY-SOLID<span class="text-primary"></span> </a></h1>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/ewe5.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 mb-3 mb-lg-0">
              <div class="d-flex quick-info-2">
                ...
                <div class="text">
                  ...
                  <span class="excerpt">L 37 No 9 <br> Mendi Avenue <br> Langa  <br> 7455</span>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-3 mb-3 mb-lg-0">
              <div class="d-flex quick-info-2">
                ...
                <div class="text">
                  ...
                  <span class="excerpt"><a href="#">084 833 0005 <br> 083 470 3853<br></span>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-3 mb-3 mb-lg-0">
              <div class="d-flex quick-info-2">
                ...
                <div class="text">
                  <strong class="d-block heading">Email us</strong>
                  <span class="excerpt"><a href="contact.html">admin@ewenjewp.co.za <br>sales@ewenjewp.co.za</a></span>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-3 mb-3 mb-lg-0">
              <div class="d-flex quick-info-2">
                ...
                <div class="text">
                  ...
                  <span class="excerpt">Mon-Fri 16:00 - 22:00<p>Sat-Sun-Holiday 08:00-22:00</p></span>
                </div>
              </div>
            </div>
          </div>
